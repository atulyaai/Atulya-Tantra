...
class TestSafeEval:
    ...
    def test_basic_arithmetic(self):
        from tantra.core.npdna.safe_eval import safe_math_eval
    ...
    def test_blocks_dangerous_code(self):
        from tantra.core.npdna.safe_eval import safe_math_eval, SafeExpressionError
    ...
    def test_safe_expression_output_basic(self):
        from tantra.core.npdna.safe_eval import safe_expression_output
