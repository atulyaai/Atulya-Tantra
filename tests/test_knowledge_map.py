...
class TestVectorIndex:
    """Tests for VectorIndex — cosine similarity based ANN."""

    def test_add_and_search(self):
        from atulya.rag.knowledge_map import VectorIndex
...
class TestKnowledgeMap:
    """Tests for KnowledgeMap — RAG, fact checking, relations."""

    def test_add_knowledge(self):
        from atulya.rag.knowledge_map import KnowledgeMap
...
class TestLoRASimulator:
    """Tests for LoRASimulator — CPU-based LoRA adapter simulation."""

    def test_create_adapter(self):
        from atulya.rag.knowledge_map import LoRASimulator
...
class TestTrainingTypeRegistry:
    """Tests for TrainingTypeRegistry — training type metadata."""

    def test_list_types(self):
        from atulya.rag.knowledge_map import TrainingTypeRegistry
