...
class TestGeneration:
    ...
    def test_repetition_penalty_applied(self):
        from tantra.core.npdna.generation import _apply_repetition_penalty
    ...
    def test_apply_top_k_selects_top(self):
        from tantra.core.npdna.generation import _apply_top_k
    ...
    def test_apply_top_p_selects(self):
        from tantra.core.npdna.generation import _apply_top_p
    ...
    def test_build_suppression_mask_no_special(self):
        from tantra.core.npdna.generation import _build_suppression_mask
        from tantra.core.npdna.tokenizer import SPECIAL_TOKENS
    ...
    def test_build_chat_prompt_simple(self):
        from tantra.core.npdna.generation import _build_chat_prompt
