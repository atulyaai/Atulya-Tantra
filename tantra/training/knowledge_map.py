"""Knowledge Map + Vector RAG â€” real fact check, RAG/LoRA/all training types."""
...
class KnowledgeMap:
    ...
    def __init__(self, data_dir: str | Path = "assets/knowledge_map"):
    ...
    def retrieve(self, query: str, top_k: int = 10) -> list[KnowledgeNode]:
        """RAG retrieval â€” find most relevant knowledge."""
