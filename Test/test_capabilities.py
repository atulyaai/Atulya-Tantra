...
When asked about capabilities, explain these specific features. Be helpful and direct.
...
def test_capabilities():
    print("🧪 Testing Tantra's capabilities...")
    
    brain = TantraBrain()
    
    # Test capabilities
    print("\n1. Testing capabilities knowledge:")
    response1 = brain.generate_response("What can you do?")
    print(f"Response: {response1}")
    
    print("\n2. Testing specific capability:")
    response2 = brain.generate_response("Can you control my computer?")
    print(f"Response: {response2}")
    
    print("\n3. Testing system commands:")
    response3 = brain.generate_response("What system commands can you execute?")
